...
class Employee(BaseModel):
    ...
    # summa(lar) — har doim aniq, individual kiritilgan qiymat sifatida
    # saqlanadi (alohida "standart" shabloni yo'q, docs "Buyurtmalar va
    # topshiriqlar tizimi" §8), Payslip.recompute() shu yerdagi qiymatlarga
    # tayanadi.
